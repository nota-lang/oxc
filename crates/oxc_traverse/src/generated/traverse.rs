...
pub trait Traverse<'a, State> {
    ...
    #[inline]
    fn enter_elision(&mut self, node: &mut Elision, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_elision(&mut self, node: &mut Elision, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_property_key(&mut self, node: &mut PropertyKey<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    #[inline]
    fn exit_property_key(&mut self, node: &mut PropertyKey<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_argument(&mut self, node: &mut Argument<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_argument(&mut self, node: &mut Argument<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_super(&mut self, node: &mut Super, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_super(&mut self, node: &mut Super, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_statement(&mut self, node: &mut Statement<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_statement(&mut self, node: &mut Statement<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_directive(&mut self, node: &mut Directive<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_directive(&mut self, node: &mut Directive<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_hashbang(&mut self, node: &mut Hashbang<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_hashbang(&mut self, node: &mut Hashbang<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_declaration(&mut self, node: &mut Declaration<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_declaration(&mut self, node: &mut Declaration<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_switch_case(&mut self, node: &mut SwitchCase<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_switch_case(&mut self, node: &mut SwitchCase<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn exit_catch_clause(&mut self, node: &mut CatchClause<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_function(&mut self, node: &mut Function<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_function(&mut self, node: &mut Function<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_static_block(&mut self, node: &mut StaticBlock<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    #[inline]
    fn exit_static_block(&mut self, node: &mut StaticBlock<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_with_clause(&mut self, node: &mut WithClause<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_with_clause(&mut self, node: &mut WithClause<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_null_literal(&mut self, node: &mut NullLiteral, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_null_literal(&mut self, node: &mut NullLiteral, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn exit_jsx_fragment(&mut self, node: &mut JSXFragment<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_jsx_child(&mut self, node: &mut JSXChild<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_jsx_child(&mut self, node: &mut JSXChild<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_jsx_text(&mut self, node: &mut JSXText<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_jsx_text(&mut self, node: &mut JSXText<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_ts_enum_body(&mut self, node: &mut TSEnumBody<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ts_enum_body(&mut self, node: &mut TSEnumBody<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_ts_literal(&mut self, node: &mut TSLiteral<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ts_literal(&mut self, node: &mut TSLiteral<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_ts_type(&mut self, node: &mut TSType<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ts_type(&mut self, node: &mut TSType<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn exit_ts_union_type(&mut self, node: &mut TSUnionType<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    ...
    #[inline]
    fn exit_ts_array_type(&mut self, node: &mut TSArrayType<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    ...
    #[inline]
    fn exit_ts_tuple_type(&mut self, node: &mut TSTupleType<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    ...
    #[inline]
    fn enter_ts_rest_type(&mut self, node: &mut TSRestType<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ts_rest_type(&mut self, node: &mut TSRestType<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_ts_any_keyword(&mut self, node: &mut TSAnyKeyword, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ts_any_keyword(&mut self, node: &mut TSAnyKeyword, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn exit_ts_null_keyword(&mut self, node: &mut TSNullKeyword, ctx: &mut TraverseCtx<'a, State>) {
    }
    ...
    #[inline]
    fn exit_ts_void_keyword(&mut self, node: &mut TSVoidKeyword, ctx: &mut TraverseCtx<'a, State>) {
    }
    ...
    #[inline]
    fn enter_ts_this_type(&mut self, node: &mut TSThisType, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ts_this_type(&mut self, node: &mut TSThisType, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_ts_type_name(&mut self, node: &mut TSTypeName<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_ts_type_name(&mut self, node: &mut TSTypeName<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_ts_signature(&mut self, node: &mut TSSignature<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    #[inline]
    fn exit_ts_signature(&mut self, node: &mut TSSignature<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn exit_ts_infer_type(&mut self, node: &mut TSInferType<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    ...
    #[inline]
    fn exit_ts_type_query(&mut self, node: &mut TSTypeQuery<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    ...
    #[inline]
    fn enter_decorator(&mut self, node: &mut Decorator<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_decorator(&mut self, node: &mut Decorator<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    ...
    #[inline]
    fn enter_nota_markup(&mut self, node: &mut NotaMarkup<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_markup(&mut self, node: &mut NotaMarkup<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_form(&mut self, node: &mut NotaForm<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_form(&mut self, node: &mut NotaForm<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_markup_kind(
        &mut self,
    ...
    #[inline]
    fn enter_nota_child(&mut self, node: &mut NotaChild<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_child(&mut self, node: &mut NotaChild<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_text(&mut self, node: &mut NotaText<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_text(&mut self, node: &mut NotaText<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_statement(
        &mut self,
    ...
    #[inline]
    fn enter_nota_element(&mut self, node: &mut NotaElement<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    #[inline]
    fn exit_nota_element(&mut self, node: &mut NotaElement<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_tag(&mut self, node: &mut NotaTag<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_tag(&mut self, node: &mut NotaTag<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_host_name(
        &mut self,
    ...
    #[inline]
    fn enter_nota_prop(&mut self, node: &mut NotaProp<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_prop(&mut self, node: &mut NotaProp<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_field_prop(
        &mut self,
    ...
    #[inline]
    fn enter_nota_if(&mut self, node: &mut NotaIf<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_if(&mut self, node: &mut NotaIf<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_else(&mut self, node: &mut NotaElse<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_else(&mut self, node: &mut NotaElse<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_for(&mut self, node: &mut NotaFor<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_for(&mut self, node: &mut NotaFor<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_code(&mut self, node: &mut NotaCode<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_code(&mut self, node: &mut NotaCode<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_math(&mut self, node: &mut NotaMath<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
    fn exit_nota_math(&mut self, node: &mut NotaMath<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_verbatim(
        &mut self,
    ...
    #[inline]
    fn enter_nota_heading(&mut self, node: &mut NotaHeading<'a>, ctx: &mut TraverseCtx<'a, State>) {
    }
    #[inline]
    fn exit_nota_heading(&mut self, node: &mut NotaHeading<'a>, ctx: &mut TraverseCtx<'a, State>) {}

    #[inline]
    fn enter_nota_list_item(
        &mut self,
    ...
    #[inline]
    fn enter_nota_attrs(&mut self, node: &mut NotaAttrs<'a>, ctx: &mut TraverseCtx<'a, State>) {}
    #[inline]
