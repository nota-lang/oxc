...
unsafe fn walk_nota_document<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_child<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_text<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaText<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_statement<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_element<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_tag<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaTag<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_host_name<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_dynamic_tag<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_prop<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaProp<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_field_prop<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_prop_name<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_prop_value<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_prop_expr<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_shorthand_prop<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_spread_prop<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_fragment<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_interpolation<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_if<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaIf<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_else<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaElse<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_for<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaFor<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_code<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaCode<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_math<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
    node: *mut NotaMath<'a>,
    ctx: &mut TraverseCtx<'a, State>,
) {
...
unsafe fn walk_nota_math_part<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_verbatim<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_verbatim_part<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_emphasis<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_heading<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
...
unsafe fn walk_nota_list_item<'a, State, Tr: Traverse<'a, State>>(
    traverser: &mut Tr,
