...
impl AstKind<'_> {
    ...
    pub fn debug_name(&self) -> std::borrow::Cow<'_, str> {
        ...
        match self {
            ...
            Self::NotaDocument(_) => "NotaDocument".into(),
            Self::NotaText(_) => "NotaText".into(),
            Self::NotaStatement(_) => "NotaStatement".into(),
            Self::NotaElement(_) => "NotaElement".into(),
            Self::NotaHostName(_) => "NotaHostName".into(),
            Self::NotaDynamicTag(_) => "NotaDynamicTag".into(),
            Self::NotaFieldProp(_) => "NotaFieldProp".into(),
            Self::NotaPropName(_) => "NotaPropName".into(),
            Self::NotaPropExpr(_) => "NotaPropExpr".into(),
            Self::NotaShorthandProp(_) => "NotaShorthandProp".into(),
            Self::NotaSpreadProp(_) => "NotaSpreadProp".into(),
            Self::NotaFragment(_) => "NotaFragment".into(),
            Self::NotaInterpolation(_) => "NotaInterpolation".into(),
            Self::NotaIf(_) => "NotaIf".into(),
            Self::NotaFor(_) => "NotaFor".into(),
            Self::NotaCode(_) => "NotaCode".into(),
            Self::NotaMath(_) => "NotaMath".into(),
            Self::NotaVerbatim(_) => "NotaVerbatim".into(),
            Self::NotaEmphasis(_) => "NotaEmphasis".into(),
