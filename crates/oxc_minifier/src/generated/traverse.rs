...
pub trait Traverse<'a> {
    ...
    #[inline]
    fn enter_nota_form(&mut self, node: &mut NotaForm<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_nota_form(&mut self, node: &mut NotaForm<'a>, ctx: &mut TraverseCtx<'a>) {}
    ...
    #[inline]
    fn enter_nota_attrs(&mut self, node: &mut NotaAttrs<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_nota_attrs(&mut self, node: &mut NotaAttrs<'a>, ctx: &mut TraverseCtx<'a>) {}

    #[inline]
    fn enter_nota_link(&mut self, node: &mut NotaLink<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_nota_link(&mut self, node: &mut NotaLink<'a>, ctx: &mut TraverseCtx<'a>) {}

    #[inline]
    fn enter_nota_image(&mut self, node: &mut NotaImage<'a>, ctx: &mut TraverseCtx<'a>) {}
    #[inline]
    fn exit_nota_image(&mut self, node: &mut NotaImage<'a>, ctx: &mut TraverseCtx<'a>) {}
