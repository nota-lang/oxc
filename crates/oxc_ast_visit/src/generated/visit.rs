...
pub mod walk {
    ...
    #[inline]
    pub fn walk_ts_global_declaration<'a, V: Visit<'a>>(
        visitor: &mut V,
    ...
    pub fn walk_nota_form<'a, V: Visit<'a>>(visitor: &mut V, it: &NotaForm<'a>) {
        // No `AstKind` for this type
        match it {
    ...
    pub fn walk_nota_markup_kind<'a, V: Visit<'a>>(visitor: &mut V, it: &NotaMarkupKind<'a>) {
        ...
        match it {
            ...
            match_nota_form!(NotaMarkupKind) => visitor.visit_nota_form(it.to_nota_form()),
        }
    }
    ...
    pub fn walk_nota_prop_value<'a, V: Visit<'a>>(visitor: &mut V, it: &NotaPropValue<'a>) {
        ...
        match it {
            ...
            match_nota_form!(NotaPropValue) => visitor.visit_nota_form(it.to_nota_form()),
        }
    }
    ...
    pub fn walk_nota_verbatim_part<'a, V: Visit<'a>>(visitor: &mut V, it: &NotaVerbatimPart<'a>) {
        ...
        match it {
            ...
            match_nota_form!(NotaVerbatimPart) => visitor.visit_nota_form(it.to_nota_form()),
        }
    }
    ...
    #[inline]
    pub fn walk_nota_thematic_break<'a, V: Visit<'a>>(visitor: &mut V, it: &NotaThematicBreak) {
        let kind = AstKind::NotaThematicBreak(visitor.alloc(it));
        visitor.enter_node(kind);
        visitor.visit_span(&it.span);
        visitor.leave_node(kind);
    }
